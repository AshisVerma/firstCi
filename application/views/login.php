...
font-weight: normal !important];
	...
	<link href="https://fonts.googleapis.com/css2?family=Arvo:wght@700&family=Hind+Madurai:wght@300;400&family=Poppins:ital,wght@0,300;1,200&family=Righteous&family=Sarabun:wght@200&family=Varela+Round&display=swap" rel="stylesheet">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('public/alert.css')?>">
 ...
 <div class="container">
        <div class="forms-container">
          <div class="signin-signup">
            <form action="<?php echo site_url('user') ?>" class="sign-in-form" method="post">
              <h2 class="title animate-charcter">Login With us</h2>
              <div class="input-field">
                <i class="fas fa-user"></i>
                <input type="text" name="username" autocomplete="username" placeholder="Username or Email" required>
              </div>
              <div class="input-field">
                <i class="fas fa-lock"></i>
                <input type="password" name="password" autocomplete="current-password" placeholder="Password" id="id_password" required=>
            ...
            <form action="<?php echo site_url('user/register') ?>" class="sign-up-form"  method="post">
              <h2 class="title animate-charcter">Register Now!..</h2>
              <div class="input-field">
                <i class="fas fa-user"></i>
        ...
        <div class="panels-container">
          <div class="panel left-panel">
            <div class="content">
              <h3 class="not-account-h3 s-font">You don't have an account?</h3>
              <p class="s-font">Create your account right now to follow people and like publications</p>
          ...
          <div class="panel right-panel">
            <div class="content">
              <h3 class="s-font">Already have an account?</h3>
              <p class="s-font">Login to see your notifications and post your favorite photos</p>
...
window.addEventListener("DOMContentLoaded", function () {
  Keyboard.init();
      ...
      <script type="text/javascript" src="<?php echo base_url('public/alert.js')?>"></script>
    <script type="text/javascript">
    	 <?php if($this->session->flashdata('success')){ ?>
     	triggerAlert("<?php echo $this->session->flashdata('success'); ?>",'success');
     	...
     	<?php } if($this->session->flashdata('warning')){ ?>
     		...
     		triggerAlert("<?php echo $this->session->flashdata('warning'); ?>",'error');
